		...
		siodelko = {
			...
			:types => [
				{ 
					...
					:colors => [
						{:file => 'siodelko-fiolet.png', :name => 'violet', :price => 121},
						{:file => 'siodelko-czerwone.png', :name => 'red', :price => 122}
					] 
				},
				{ 
					:name => "Skóra", 
					:colors => [
						{:file => 'siodelko-czarne2.png', :name => 'black', :price => 321},
						{:file => 'siodelko-brazowe2.png', :name => 'brown', :price => 322}
					] 
				},
				{ 
					:name => "Eko-skóra", 
					:colors => [
						{:file => 'siodelko-czarne.png', :name => 'black', :price => 221},
						{:file => 'siodelko-czarne3.png', :name => 'black', :price => 222},
						{:file => 'siodelko-brazowe.png', :name => 'red', :price => 222},
						{:file => 'siodelko-szare.png', :name => 'red', :price => 222}
					] 
				},
			]
		}
			...
			:types => [
				{
					...
					:colors => [
						...
						{ :file => 'lancuch-fiolet.png', :name => 'violet', :price => 544},
						{ :file => 'lancuch-stalowy.png', :name => 'black', :price => 544},
						{ :file => 'lancuch-zielony.png', :name => 'green', :price => 544}
					] 
				}
			]
		}
